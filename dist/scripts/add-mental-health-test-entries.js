...
class MentalHealthTestSeeder {
    ...
    async findTestStudents() {
        try {
            ...
            const usersSnapshot = await firebase_config_1.default.auth().listUsers();
    ...
    async addTestEntriesForStudent(student, issueType) {
    ...
    async updateAnalyticsAfterSeeding() {
        try {
            ...
            const customToken = await firebase_config_1.default.auth().createCustomToken(superAdminId);
...
//# sourceMappingURL=add-mental-health-test-entries.js.map