...
exports.analyzeAllStudentJournalsIncremental = void 0;
...
const deliverResourcesAutomatically = async (studentId, issueType, studentData) => {
    try {
        ...
        const resourcesSnapshot = await firebase_config_1.default.firestore()
        ...
        resourcesSnapshot.docs.forEach((resourceDoc) => {
            ...
            const deliveredResourceRef = firebase_config_1.default.firestore()
                .collection('users')
                .doc(studentId)
...
// ================================================================================================
const analyzeAllStudentJournalsIncremental = async (req, res) => {
    try {
                    ...
                    if (totalCount >= 4) {
                        ...
                        if (existingFlag.exists && existingFlag.flagRef) {
                            ...
                            await flagRef.update({
                                ...
                                excerpts: firebase_config_1.default.firestore.FieldValue.arrayUnion(...(issueExcerpts.get(issueType) || []))
                            });
...
exports.analyzeAllStudentJournalsIncremental = analyzeAllStudentJournalsIncremental;
//# sourceMappingURL=mental-health-incremental.controller.js.map