...
exports.getAvailableSchoolAdmins = exports.getResourceAssignments = exports.assignResourceToSchoolAdmin = exports.getAssignedResources = exports.getClassHistoricalAnalytics = exports.getClassAnalytics = exports.getSchoolHistoricalAnalytics = exports.getSchoolAnalytics = exports.getDistrictHistoricalAnalytics = exports.getDistrictAnalytics = exports.getDistrictOverview = exports.deleteSchoolAdmin = exports.suspendOrUnsuspendSchoolAdmin = exports.updateSchoolAdmin = exports.getSchoolAdmins = exports.createSchoolAdmin = exports.deleteSchool = exports.updateSchool = exports.getSchools = exports.createSchool = void 0;
...
const getSchools = async (req, res) => {
    try {
        ...
        const schoolsRef = firebase_config_1.default.firestore().collection("schools");
...
const deleteSchool = async (req, res) => {
    try {
        ...
        await firebase_config_1.default.firestore().collection("schools").doc(schoolId).delete();
...
const createSchoolAdmin = async (req, res) => {
    try {
        ...
        const districtRef = firebase_config_1.default.firestore().collection("districts").doc(districtId);
        ...
        const schoolRef = firebase_config_1.default.firestore().collection("schools").doc(schoolId);
        ...
        const tempPassword = app_config_1.DEFAULT_PASSWORDS.SCHOOL_ADMIN;
        ...
        const claims = (0, roleHierarchy_1.createHierarchicalClaims)(app_config_1.ROLES.SCHOOL_ADMIN, districtAdminId, {
        ...
        await firebase_config_1.default.firestore().collection("users").doc(userRecord.uid).set({
            name,
            email,
...
const getSchoolAdmins = async (req, res) => {
    try {
        ...
        const schoolsSnapshot = await firebase_config_1.default
            .firestore()
            .collection("schools")
        ...
        const schoolAdmins = listUsersResult.users
            ...
            return claims.role === app_config_1.ROLES.SCHOOL_ADMIN && claims.districtId === districtId;
        })
            .map(user => {
...
exports.getSchoolAdmins = getSchoolAdmins;
// update school admin
const updateSchoolAdmin = async (req, res) => {
    try {
        ...
        const existingUser = await firebase_config_1.default.auth().getUser(uid);
        ...
        if (phone !== undefined)
            updateData.phoneNumber = phone || null;
        await firebase_config_1.default.auth().updateUser(uid, updateData);
...
const suspendOrUnsuspendSchoolAdmin = async (req, res) => {
    try {
        const { uid } = req.params;
        ...
        return res.status(200).json({
            message: `School Admin ${user.disabled ? "Unsuspended" : "Suspended"} Successfully`,
        });
    }
    catch (error) {
...
exports.suspendOrUnsuspendSchoolAdmin = suspendOrUnsuspendSchoolAdmin;
// delete school admin
...
exports.deleteSchoolAdmin = deleteSchoolAdmin;
// District Overview
const getDistrictOverview = async (req, res) => {
    try {
        ...
        const averageEngagement = schools.reduce((sum, school) => sum + (school.engagement || 0), 0) / totalSchools || 0;
        ...
        const schoolsOverview = schools.map((school) => ({
            id: school.id,
            name: school.name,
...
exports.getDistrictOverview = getDistrictOverview;
...
const getDistrictAnalytics = async (req, res) => {
    try {
        ...
        const schoolStats = Object.entries(latestAnalytics.schoolStats || {})
            .filter(([_, schoolData]) => schoolData.districtId === districtId)
        ...
        const studentStats = Object.entries(latestAnalytics.studentStats || {})
            .filter(([_, studentData]) => studentData.districtId === districtId)
...
const assignResourceToSchoolAdmin = async (req, res) => {
    try {
        const { uid } = req.user;
        ...
        const schoolAdminData = await firebase_config_1.default.auth().getUser(schoolAdminId);
        ...
        const existingSchoolAssignment = await firebase_config_1.default.firestore()
            .collection('resource_assignments')
            .where('resourceId', '==', resourceId)
...
exports.assignResourceToSchoolAdmin = assignResourceToSchoolAdmin;
    ...
    try {
        ...
        const assignments = await Promise.all(paginatedDocs.map(async (doc) => {
            ...
            if (assignmentData.assignedTo) {
                try {
                    const schoolAdminData = await firebase_config_1.default.auth().getUser(assignmentData.assignedTo);
...
const getAvailableSchoolAdmins = async (req, res) => {
    try {
        const { uid } = req.user;
        // Get district admin's custom claims
        const adminData = await firebase_config_1.default.auth().getUser(uid);
...
exports.getAvailableSchoolAdmins = getAvailableSchoolAdmins;
//# sourceMappingURL=district-admin.controller.js.map