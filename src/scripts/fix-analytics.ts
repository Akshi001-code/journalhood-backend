    ...
    try {
      ...
      if (!previousAnalyticsSnapshot.empty) {
        ...
        Object.entries(stats.studentStats).forEach(([studentId, student]) => {
          ...
          if (previous) {
            student.weeklyGrowth = this.calculateGrowthRate(
              previous.weeklyEntries || 0,
              student.weeklyEntries || 0
            );
            student.monthlyGrowth = this.calculateGrowthRate(
        ...
        Object.entries(stats.classStats).forEach(([classId, classStats]) => {
          ...
          if (previous) {
            classStats.weeklyGrowth = this.calculateGrowthRate(
              previous.weeklyEntries || 0,
              classStats.weeklyEntries || 0
            );
            classStats.monthlyGrowth = this.calculateGrowthRate(
              previous.monthlyEntries || 0,
        ...
        Object.entries(stats.schoolStats).forEach(([schoolId, schoolStats]) => {
          ...
          if (previous) {
            schoolStats.weeklyGrowth = this.calculateGrowthRate(
              previous.weeklyEntries || 0,
              schoolStats.weeklyEntries || 0
            );
            schoolStats.monthlyGrowth = this.calculateGrowthRate(
              previous.monthlyEntries || 0,
        ...
        Object.entries(stats.districtStats).forEach(([districtId, districtStats]) => {
          ...
          if (previous) {
            districtStats.weeklyGrowth = this.calculateGrowthRate(
              previous.weeklyEntries || 0,
              districtStats.weeklyEntries || 0
            );
            districtStats.monthlyGrowth = this.calculateGrowthRate(
              previous.monthlyEntries || 0,
